          ...
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center">
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M4 2a2 2 0 00-2 2v11a3 3 0 106 0V4a2 2 0 00-2-2H4zM1 15a1 1 0 011-1h2a1 1 0 011 1v3a1 1 0 11-2 0v-1H2a1 1 0 01-1-1v-1zm13-4a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"
                  clipRule="evenodd"
                />
              </svg>
            </div>
          ...
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center">
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M9.383 3.076A1 1 0 0110 4v12a1 1 0 01-1.707.707L4.586 13H2a1 1 0 01-1-1V8a1 1 0 011-1h2.586l3.707-3.707a1 1 0 011.09-.217zM15.657 6.343a1 1 0 011.414 0A9.972 9.972 0 0119 12a9.972 9.972 0 01-1.929 5.657 1 1 0 11-1.414-1.414A7.971 7.971 0 0017 12c0-1.933-.686-3.706-1.829-5.086a1 1 0 010-1.414z"
                  clipRule="evenodd"
                />
              </svg>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700">
              Sweeten your day with a wide variety of our best selling
              delicacies
            </p>
          </div>
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center">
          ...
          <Link
            to="/products"
            className="text-red-600 hover:text-red-800 mt-4 inline-block"
          >
            Back to Products
          </Link>
        </div>
...
export const ContactUs = () => {
  ...
  const handleWhatsAppSend = (e) => {
    e.preventDefault();
    const phoneNumber = "918341366944"; // WhatsApp format: country code + number, no +
    const encodedMessage = encodeURIComponent(message);
    // Use wa.me for universal WhatsApp redirect
    window.open(
...
export const AboutUs = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
        <div>
          ...
          <div className="space-y-4 text-gray-700">
            ...
            <p>
              Varahey Sweets is more than just a sweet shop – it's a story of
              tradition, love, and timeless taste. Our journey began many years
              ago with a simple dream: to share the rich flavors of Indian
              sweets made the traditional way.
            </p>
            <p>
              Passed down through generations, our recipes carry the warmth of
              homemade goodness. Every sweet is made with care, using
              high-quality ingredients and time-tested methods. From the softest
              laddus to the richest burfis, each bite brings back memories of
              home, festivals, and family gatherings.
            </p>
            <p>
              Whether you're celebrating a festival, a special day, or just want
              to enjoy something sweet, Varahey Sweets is here to make your
              moments more joyful and delicious.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <p className="text-gray-700">
              To deliver a unique and refreshing customer experience in the
              realm of traditional Indian sweets, while preserving authentic
              recipes and embracing modern innovation to delight customers
              across generations.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-700">
              To be an integral part of celebrations and festivities across
              India, spreading joy through our premium quality sweets and
              becoming the most trusted name in traditional Indian
              confectionery.
            </p>
          </div>
        </div>
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              We use only the finest ingredients and traditional methods to
              ensure every product meets our high standards of quality and
              taste.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">
              ...
              the authentic flavors and techniques of traditional Indian sweets.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Every product is crafted with love and care, ensuring that each
              bite brings joy and creates memorable moments for our customers.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold text-gray-900 mb-4">
          Experience the Varahey Sweets Difference
        </h2>
        <p className="text-xl text-gray-600 mb-8">
          Join millions of satisfied customers who trust Varahey Sweets for
          their sweet celebrations
        </p>
        <Link
          to="/products"
          className="inline-block bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-8 rounded-lg transition-colors duration-200"
