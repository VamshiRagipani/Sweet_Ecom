            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">sales@dadus.co.in</p>
                </div>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="text-center mb-16">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">About Dadus</h1>
      ...
      {/* Call to Action */}
      <div className="text-center">
        <h2 className="text-3xl font-bold text-gray-900 mb-4">Experience the Dadus Difference</h2>
        <p className="text-xl text-gray-600 mb-8">
          Join millions of satisfied customers who trust Dadus for their sweet celebrations
        </p>
        <Link
          to="/products"
          className="inline-block bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-8 rounded-lg transition-colors duration-200"
    ...
    <footer className="bg-red-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div>
            ...
            <div className="space-y-3 text-red-100">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm">sales@dadus.co.in</span>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-red-700 mt-8 pt-8 text-center text-red-100">
          <p>&copy; Copyright 2024, DADUS. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
